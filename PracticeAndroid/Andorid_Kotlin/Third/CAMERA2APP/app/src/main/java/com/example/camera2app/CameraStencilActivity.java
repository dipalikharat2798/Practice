...
public class CameraStencilActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        b1=findViewById(R.id.capture_button);
        b2=findViewById(R.id.capture_button1);
        ...
        stencilDescription=findViewById(R.id.description);
        textture.setSurfaceTextureListener(textureListener);
        stencilDescription.setText("");
    }
...
//                    setResult(RESULT_OK, intent);
                    Toast.makeText(CameraStencilActivity.this, "Capture"+KEY_CAPTURED_STENCIL_DATA+"file name :"+file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
                    finish();
                }
            };
