package com.androdevdk.arapplication
...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animation_kick_btn.setOnClickListener { animateModel("Character|Kick") }
        animation_idle_btn.setOnClickListener { animateModel("Character|Idle") }
        animation_boxing_btn.setOnClickListener { animateModel("Character|Boxing") }
    }
