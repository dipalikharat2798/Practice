...
public class CourseRepository {
    ...
    private static class InsertCourseAsyncTask extends AsyncTask<PersonModal, Void, Void> {
        private Dao dao;
        ...
        @Override
        protected Void doInBackground(PersonModal... model) {
    ...
    private static class UpdateCourseAsyncTask extends AsyncTask<PersonModal, Void, Void> {
        private Dao dao;
        ...
        @Override
        protected Void doInBackground(PersonModal... models) {
    ...
    private static class DeleteCourseAsyncTask extends AsyncTask<PersonModal, Void, Void> {
        private Dao dao;
