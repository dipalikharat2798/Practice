...
public class ListSecActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_sec);
       ...
       // String id=getIntent().getExtras().getString("id");
        progressDialog = new ProgressDialog(ListSecActivity.this);
        ...
        adapter=new ListOneAdapter(ListSecActivity.this,model);
