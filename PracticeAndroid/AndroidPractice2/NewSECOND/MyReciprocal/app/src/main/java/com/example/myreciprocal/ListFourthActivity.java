...
public class ListFourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_fourth);
        ...
        progressDialog = new ProgressDialog(ListFourthActivity.this);
        ...
        adapter=new ListOneAdapter(ListFourthActivity.this,model);
