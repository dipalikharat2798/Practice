...
public class ListThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_third);
        ...
        progressDialog = new ProgressDialog(ListThirdActivity.this);
        ...
        adapter=new ListOneAdapter(ListThirdActivity.this,model);
