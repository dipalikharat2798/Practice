...
namespace WEBAPPENTITY.Controllers
{
    ...
    {
        private readonly NewVMDB _context;

        public Products1Controller(NewVMDB context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.Database.ExecuteSqlRawAsync("DeleteProduct @p0", product.ProductId);
            return RedirectToAction(nameof(Index));
        }
