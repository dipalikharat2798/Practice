    ...
    class AdvancedSamples
    {
        public async Task RunSamples()
        {
            ...
            try
            {
                ...
                if (!SampleUtils.IsAzureCosmosdbTable())
                {
        ...
        private static async Task TestTableSAS(string sasUri, CustomerEntity customer)
        {
            ...
            try
            {
                ...
                customer = await SampleUtils.InsertOrMergeEntityAsync(table, customer);
            ...
            try
            {
                if (customerRead != null)
                {
                    await SampleUtils.DeleteEntityAsync(table, customerRead);
                }
