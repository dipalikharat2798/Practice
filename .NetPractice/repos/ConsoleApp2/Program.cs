...
namespace ConsoleApp2
{
    class Program
    {
        static string connectionString = "Endpoint=sb://contososbusnsd.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=M/WRt6UZ+XoUeBqhy8yoxo9yO4bLXXwSTs9IjK236UE=";
        static string queueName = "contosoordersqueue";
