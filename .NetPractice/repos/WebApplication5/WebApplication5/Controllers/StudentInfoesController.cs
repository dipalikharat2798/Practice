...
namespace WebApplication5.Controllers
{
    ...
    {
        private VMDB2Entities db = new VMDB2Entities();
        ...
        public ActionResult Create([Bind(Include = "ID,NAME,AGE,ADDRESS")] StudentInfo studentInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NAME,AGE,ADDRESS")] StudentInfo studentInfo)
        {
            if (ModelState.IsValid)
            {
